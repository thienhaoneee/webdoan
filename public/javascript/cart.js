    ...
    $.ajax({
        ...
        success: function(response) {
            if(!response.error) {
                ...
                const totalAllElement = document.querySelector('.cart-total__money-price');
    ...
    $.ajax({
        ...
        success: function(response) {
            if(response.error) {
                ...
                const product = document.querySelector(`.cart-product-${id}`);
                const productInput = product.querySelector('.cart-shopping__col-quantity-input');
                const totalElement = product.querySelector('.cart-shopping__col-total');

                let thanhtien = response.product.price * response.product.quantity;
                ...
                console.log('productInput :>> ', productInput.value);
