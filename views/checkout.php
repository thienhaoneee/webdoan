...
<div class="checkout">
    ...
    <?php
        ...
        if(!isset($_SESSION['cart']) || count($_SESSION['cart'])==0):
            echo "<script>alert('Gio hang dang trong')</script>";
            ...
            <div class="rw">
                <div class="column c-8">
                    <div class="checkout-shopping">
                        <div class="checkout-shopping__title-wrapper">
                            ...
                            <p>Giỏ hàng (<span>1</span> Sản Phẩm)</p>
                        </div>
                    ...
                    <div class="checkout-info">
                        ...
                        <form class="checkout-info__form">
                            <div class="rw">
                                <div class="column c-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">Họ tên người nhận:</label>
                                        <input type="text" class="form-control" required name="user_name" placeholder="Nhập họ tên người nhận">
                                    </div>
                                </div>
                                <div class="column c-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">Số điện thoại người nhận:</label>
                                        <input type="text" class="form-control" required name="user_phone" placeholder="Số điện thoại người nhận">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" required name="user_email" placeholder="Nhập Email người nhận">
                            </div>
                            <div class="form-group">
                                <label for="" class="form-label">Địa chỉ người nhận:</label>
                                <input type="text" class="form-control" required name="user_address" placeholder="Nhập họ tên người nhận">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="column c-4">
                    <div class="checkout-total">
                        ...
                        <div class="checkout-total__payment-btn">
                            <a href="#">
                                Thanh toán
                            </a>
                        </div>
